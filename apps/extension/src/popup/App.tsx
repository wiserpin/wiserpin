...
type ViewType = 'create-pin' | 'collections' | 'create-collection' | 'select-collection' | 'settings';

export function App() {
  const [view, setView] = useState<ViewType>('create-pin');
  ...
  return (
    <div className="w-[400px] min-w-[400px] h-[600px] flex flex-col bg-white dark:bg-gray-900">
      {/* Fixed Header */}
      <div className="flex-shrink-0 text-white" style={{backgroundColor: '#ff751f'}}>
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center">
            <img src="/logo.png" alt="WiserPin" className="h-12" />
          </div>
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                view === 'collections' ? 'bg-black/20' : 'hover:bg-black/10'
              }`}
              title="Collections"
            >
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                view === 'settings' ? 'bg-black/20' : 'hover:bg-black/10'
              }`}
              title="Settings"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
